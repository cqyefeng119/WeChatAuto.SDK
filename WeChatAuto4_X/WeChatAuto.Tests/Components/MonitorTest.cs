...
public class MonitorTest
{
    ...
    // [Fact(DisplayName = "开放式监听-收集图片-新增好友信息 - vip功能")]
    ...
    // [Fact(DisplayName = "固定好友、群监听 - vip功能")]
    ...
    // [Fact(DisplayName = "开放式好友、群监听_风控 - vip功能")]
    ...
    // [Theory(DisplayName = "测试开始时间-结束时间的消息监听 - vip功能")]
    // [InlineData("", "")]
    ...
    // [Fact(DisplayName = "测试多个时间段的监听 - vip功能")]
    ...
    // [Fact(DisplayName = "测试监听系统信息 - vip功能")]

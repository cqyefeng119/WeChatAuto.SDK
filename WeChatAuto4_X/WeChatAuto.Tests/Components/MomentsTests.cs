...
public class MomentsTests
{
    ...
    // [Fact(DisplayName = "打开朋友圈-关闭朋友圈-vip功能")]
    ...
    // [Fact(DisplayName = "发朋友圈-多标签-vip功能")]
    ...
    // [Fact(DisplayName = "发朋友圈-测试错误情况 - vip 功能")]
    ...
    // [Fact(DisplayName = "删除朋友圈-故意设置错误 - vip 功能")]

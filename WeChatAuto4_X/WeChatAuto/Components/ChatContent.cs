...
namespace WeChatAuto.Components
{
    public class ChatContent
    {
		...
		/// <returns></returns>
        public async Task SendVoiceMessageWithTTS(string who, string message, VoiceOptions options, Func<string, byte[]> customProcess = null) => await Sender.SendVoiceMessageWithTTS(who, message, options, customProcess);
        ...
        public async Task<List<ChatSimpleMessage>> GetChatHistory(DateTime dates = default) => await _MessageList.GetChatHistory(dates);
